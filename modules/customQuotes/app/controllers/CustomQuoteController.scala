...
class CustomQuoteController @Inject()(
  ...
  def getCustomQuotes: Action[AnyContent] = UserAction { implicit request =>
    ...
    val customQuotes = (user: UserDetail) => responseSeqResult(customerQuotesDAO.listAllQuotes(user.id))
  ...
  def getRandomCustomQuote: Action[AnyContent] = UserAction { implicit request =>
    ...
    val randomCustomQuote = (user: UserDetail) => responseSeqResult(customerQuotesDAO.listRandomQuote(1, user.id))
  ...
  def getSelectedQuote(id: Int): Action[AnyContent] = UserAction { implicit request =>
    ...
    val selectedQuote = (user: UserDetail) => responseOptionResult(customerQuotesDAO.listSelectedQuote(id, user.id))
  ...
  /**
    ...
    */
  def deleteCustomQuote(id: Int): Action[AnyContent] = UserAction { implicit request: Request[AnyContent] =>
  ...
  /**
    ...
    */
  def updateCustomQuote(id: Int): Action[AnyContent] = UserAction { implicit request: Request[AnyContent] =>

/*
 * NOTE: https://github.com/playframework/scalatestplus-play/issues/112
 ...
 */
trait BaseOneAppPerSuiteAsync extends AsyncTestSuiteMixin {
  this: AsyncTestSuite with FakeApplicationFactory =>
...
trait GuiceOneAppPerSuiteAsync
    extends scala.AnyRef
    with BaseOneAppPerSuiteAsync
    with org.scalatestplus.play.guice.GuiceFakeApplicationFactory {
